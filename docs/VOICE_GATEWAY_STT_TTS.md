...
| `VOICE_TTS_PROVIDER` | **voice-gateway** | `deepgram` (default), `elevenlabs`, `cartesia` |
...
| `SPEECHMATICS_API_KEY` | **voice-gateway** | Required when `VOICE_STT_PROVIDER=speechmatics` (STT only) |
