...
from hanok_table.models import ReservationStatus
...
class ReservationCreate(BaseModel):
    ...
    @classmethod
    def unwrap_hanok_table_payload_and_lift_preorder(cls, data: Any) -> Any:
    ...
    def lower_source_channel(cls, v: Any) -> Any:
        ...
        if s in ("online", "voice", "api"):
            return s
        if s in ("ai", "assistant", "hanok_table", "agent", "tool", "automation", "ivr", "bot"):
            return "api"
        return "api"
