...
from hanok_table.models import Reservation, ReservationStatus, TableSlotInventory
from hanok_table.reminders import schedule_reminder_on_table_allocated
from hanok_table.table_allocation import (
    allocate_tables,
