...
from hanok_table.routers.webhook import _enrich_caller_identification_for_profile
...
def test_enrich_no_caller_skips_db_hint() -> None:
    ...
    assert "hanok_table_end_user_target" in p["guest_lookup_identification_hint"].lower()
...
def test_enrich_normalizes_us_ani(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    assert p["caller_phone_hanok_table"] == "+1 (415) 555-0100"
