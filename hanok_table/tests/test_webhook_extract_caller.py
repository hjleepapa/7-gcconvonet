...
def test_prefers_hanok_table_end_user_target_over_opaque_sip_from() -> None:
    cred = "gencred3g3omnmI1BywYcKi2MwGM8m4GABDyKaWUiuR1erO1X@sip.telnyx.com"
    got = extract_caller_number(
        {
            "from": cred,
            "hanok_table_end_user_target": "+19259897818",
        }
    )
...
def test_nested_payload_hanok_table_before_from() -> None:
