"""Hanok Table template aliases and defensive premium backfill on dynamic variables."""

from __future__ import annotations

from hanok_table.routers.webhook import (
    _ensure_premium_concierge_on_profile,
    _premium_concierge_variables,
    _hanok_table_template_alias_variants,
)
...
def test_hanok_table_alias_variants_mirror_values() -> None:
    p: dict = {
    ...
    _hanok_table_template_alias_variants(p)
