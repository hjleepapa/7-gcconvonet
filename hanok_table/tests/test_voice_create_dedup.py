...
from hanok_table.routers.reservations import _voice_create_recent_duplicate
from hanok_table.schemas_res import PreorderLineIn, ReservationCreate, ReservationUpdate
...
def test_voice_dedup_merge_preorder_on_stub(db_session) -> None:
    from hanok_table.routers.reservations import _apply_reservation_update
